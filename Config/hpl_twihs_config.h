...
/* TWI1 peripheral clock frequency */
#ifndef CONF_TWIHS1_FREQUENCY
#define CONF_TWIHS1_FREQUENCY (CONF_TWIHS1_FREQUENCY)
#endif
...
// <i> I2C Bus clock (SCL) speed measured in Hz
// <id> i2c_master_baud_rate
#ifndef CONF_TWIHS1_BAUD
#define CONF_TWIHS1_BAUD 100000
#endif
...
// <e> Advanced configuration
// <id> i2c_master_advanced
#ifndef CONF_TWIHS1_ADVANCED_CONFIG
#define CONF_TWIHS1_ADVANCED_CONFIG 0
#endif

// <q> SMBus Mode Enabled
// <i> Determine if the SMBus mode enabled
// <id> i2c_master_smbus_enable
#ifndef CONF_TWIHS1_SMBEN
#define CONF_TWIHS1_SMBEN 0
#endif

// <q> Packet Error Checking
// <i> SMBus PEC (CRC) generation and check enabled
// <id> i2c_master_packet_error_check
#ifndef CONF_TWIHS1_PECEN
#define CONF_TWIHS1_PECEN 0
#endif
...
// <i> Used to specify how to prescale the TLOWS, TLOWM and THMAX counters in SMBTR
// <id> i2c_master_smbus_clock_prescaler
#ifndef CONF_TWIHS1_SMBTR_PRESC
#define CONF_TWIHS1_SMBTR_PRESC 0
#endif
...
// <i> Used to time TLOW:MEXT. If 0, timeout check disabled.
// <id> i2c_master_tlow_mext
#ifndef CONF_TWIHS1_SMBTR_TLOWM
#define CONF_TWIHS1_SMBTR_TLOWM 0
#endif
...
// <i> Used to time TLOW:SEXT. If 0, timeout check disabled.
// <id> i2c_master_tlow_sext
#ifndef CONF_TWIHS1_SMBTR_TLOWS
#define CONF_TWIHS1_SMBTR_TLOWS 0
#endif
...
// <i> bus free detection. Used to time THIGH:MAX.
// <id> i2c_master_thigh_max
#ifndef CONF_TWIHS1_SMBTR_THMAX
#define CONF_TWIHS1_SMBTR_THMAX 0
#endif

// <q> RX Digital Filter Enable
// <i> TWIHS input filtering is active (only in Standard and Fast modes)
// <id> i2c_master_digital_filter_enable
#ifndef CONF_TWIHS1_FILTR_FILT
#define CONF_TWIHS1_FILTR_FILT 0
#endif

// <q> PAD Filter Enable
// <i> PAD analog filter is enabled (The analog filter must be enabled if High-speed mode is enabled)
// <id> i2c_master_pad_filter_enable
#ifndef CONF_TWIHS1_FILTR_PADFEN
#define CONF_TWIHS1_FILTR_PADFEN 0
#endif
...
// <i> Maximum pulse width of spikes to be suppressed by the input filter, defined in peripheral clock cycles.
// <id> i2c_master_filter_threshold
#ifndef CONF_TWIHS1_FILTR_THRES
#define CONF_TWIHS1_FILTR_THRES 0
#endif

// </e>

/* Configuration for CR (Control Register) */
#ifndef CONF_TWIHS1_CR_REG
#define CONF_TWIHS1_CR_REG                                                                                             \
	(TWIHS_CR_SVDIS | (CONF_TWIHS1_SMBEN << TWIHS_CR_SMBEN_Pos) | (CONF_TWIHS1_PECEN << TWIHS_CR_PECEN_Pos))
#endif
...
/* Configuration for FILTR(TWI Filter Register Register) */
#ifndef CONF_TWIHS1_FILTR_REG
#define CONF_TWIHS1_FILTR_REG                                                                                          \
	((CONF_TWIHS1_FILTR_FILT << TWIHS_FILTR_FILT_Pos) | (CONF_TWIHS1_FILTR_PADFEN << TWIHS_FILTR_PADFEN_Pos)           \
	 | (CONF_TWIHS1_FILTR_THRES << TWIHS_FILTR_THRES_Pos))
#endif

/* The peripheral clock is the source clock for the bit rate generation when
 * CONF_TWIHS1_CWGR_BRSRCCLK == 0
 *                 1          (CLDIV * CKDIV_val + 3)
 * Tlow = --------------- = ------------------------------
 *         baudrate * 2       PeripheralFrequency(HZ)
 */
#define CONF_TWIHS1_CWGR_CLDIV_CALC(freq, baud, ckdiv) (((freq / (baud * 2)) - 3) / ckdiv)

/* Find a valid CWGR_CKDIV value and Check if the CONF_TWIHS1_CKDIV will overflow */
#ifndef CONF_TWIHS1_CWGR_CKDIV
#if CONF_TWIHS1_CWGR_CLDIV_CALC(CONF_TWIHS1_FREQUENCY, CONF_TWIHS1_BAUD, 1) <= 255
#define CONF_TWIHS1_CWGR_CKDIV 0
#elif CONF_TWIHS1_CWGR_CLDIV_CALC(CONF_TWIHS1_FREQUENCY, CONF_TWIHS1_BAUD, 2) <= 255
#define CONF_TWIHS1_CWGR_CKDIV 1
#elif CONF_TWIHS1_CWGR_CLDIV_CALC(CONF_TWIHS1_FREQUENCY, CONF_TWIHS1_BAUD, 4) <= 255
#define CONF_TWIHS1_CWGR_CKDIV 2
#elif CONF_TWIHS1_CWGR_CLDIV_CALC(CONF_TWIHS1_FREQUENCY, CONF_TWIHS1_BAUD, 8) <= 255
#define CONF_TWIHS1_CWGR_CKDIV 3
#elif CONF_TWIHS1_CWGR_CLDIV_CALC(CONF_TWIHS1_FREQUENCY, CONF_TWIHS1_BAUD, 16) <= 255
#define CONF_TWIHS1_CWGR_CKDIV 4
#elif CONF_TWIHS1_CWGR_CLDIV_CALC(CONF_TWIHS1_FREQUENCY, CONF_TWIHS1_BAUD, 32) <= 255
#define CONF_TWIHS1_CWGR_CKDIV 5
#elif CONF_TWIHS1_CWGR_CLDIV_CALC(CONF_TWIHS1_FREQUENCY, CONF_TWIHS1_BAUD, 64) <= 255
#define CONF_TWIHS1_CWGR_CKDIV 6
#elif CONF_TWIHS1_CWGR_CLDIV_CALC(CONF_TWIHS1_FREQUENCY, CONF_TWIHS1_BAUD, 128) <= 255
#define CONF_TWIHS1_CWGR_CKDIV 7
#else
#error Failed to generate TWI1 I2C baudrate, please check settings.
#endif
#endif /* end ifndef CONF_TWIHS1_CWGR_CKDIV */

/* TWIHS_CWGR_CKDIV Result value for calc CWGR_CLDIV and CWGR_CHDIV */
#if CONF_TWIHS1_CWGR_CKDIV == 0
#define CONF_TWIHS1_CWGR_CKDIV_val 1
#elif CONF_TWIHS1_CWGR_CKDIV == 1
#define CONF_TWIHS1_CWGR_CKDIV_val 2
#elif CONF_TWIHS1_CWGR_CKDIV == 2
#define CONF_TWIHS1_CWGR_CKDIV_val 4
#elif CONF_TWIHS1_CWGR_CKDIV == 3
#define CONF_TWIHS1_CWGR_CKDIV_val 8
#elif CONF_TWIHS1_CWGR_CKDIV == 4
#define CONF_TWIHS1_CWGR_CKDIV_val 16
#elif CONF_TWIHS1_CWGR_CKDIV == 5
#define CONF_TWIHS1_CWGR_CKDIV_val 32
#elif CONF_TWIHS1_CWGR_CKDIV == 6
#define CONF_TWIHS1_CWGR_CKDIV_val 64
#elif CONF_TWIHS1_CWGR_CKDIV == 7
#define CONF_TWIHS1_CWGR_CKDIV_val 128
#endif

/* Clock Waveform Generator Register Clock Divider */
#ifndef CONF_TWIHS1_CWGR_CLDIV
#define CONF_TWIHS1_CWGR_CLDIV                                                                                         \
	(CONF_TWIHS1_CWGR_CLDIV_CALC(CONF_TWIHS1_FREQUENCY, CONF_TWIHS1_BAUD, CONF_TWIHS1_CWGR_CKDIV_val))
#endif

/* CHDIV same as CLDIV for generator a 50 duty cycle clock */
#ifndef CONF_TWIHS1_CWGR_CHDIV
#define CONF_TWIHS1_CWGR_CHDIV CONF_TWIHS1_CWGR_CLDIV
#endif /* endif CONF_TWIHS1_CWGR_BRSRCCLK == 1 */

/* Configuration for CWGR(TWI Clock Waveform Generator Register) */
#ifndef CONF_TWIHS1_CWGR_REG
#define CONF_TWIHS1_CWGR_REG                                                                                           \
	(TWIHS_CWGR_CKDIV(CONF_TWIHS1_CWGR_CKDIV) | TWIHS_CWGR_CHDIV(CONF_TWIHS1_CWGR_CHDIV)                               \
	 | TWIHS_CWGR_CLDIV(CONF_TWIHS1_CWGR_CLDIV))
#endif
